...
class EmailNotificationPolicy
{
     ...
     */
    public function restore(User $user, EmailNotification $emailNotification): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, EmailNotification $emailNotification): bool
    {
        return false;
    }
}
