...
function SettingsPage({
  ...
  const items = [
    {
      ...
      children: (
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-semibold text-[#16243f] mb-4">
            ...
            >
              ...
              >
                <Input className="rounded-lg focus:border-[#16243f]" />
              </Form.Item>
              ...
              <Button
                ...
                htmlType="submit"
                loading={loading}
                className="w-full md:w-auto bg-[#0e8a86] hover:bg-[#0fb5ae]"
              >
                Update Profile
              </Button>
            </Form>
          ...
          <div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <Button
                ...
                className="bg-[#0e8a86] hover:bg-[#0fb5ae]"
              >
                Change Password
              </Button>
            </div>
    ...
    },
    {
      ...
      children: (
        <div className="space-y-6">
          <h3 className="text-lg font-semibold text-[#16243f]">
    ...
    },
    {
      ...
      children: (
        <div className="space-y-6">
          <h3 className="text-lg font-semibold text-[#16243f]">Account Actions</h3>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <Button
                ...
                className="border-[#16243f] text-[#16243f]"
              >
                Download
              </Button>
            </div>
  ...
  return (
    <div className="w-full">
      <div className="w-full max-w-4xl bg-white border border-[#e5e7eb] shadow-2xl rounded-lg md:rounded-2xl p-3 md:p-6 lg:p-8 relative z-10">
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-extrabold text-[#16243f] mb-2 text-center tracking-tight">
            Settings
          </h1>
